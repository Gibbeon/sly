...
namespace sly {
    namespace gfx {
        ...
        public:
            ...
            {
                Memory::set(eDataFormat_Default, rtvFormats, 8);
            }

            ref_t<IShader> vsShader;
            ref_t<IShader> psShader;
            size_t sampleMax;
        ...
        class IRenderState {
        public:
            virtual void init(ref_t<RenderStateDesc> desc) = 0;
        };
        ...
        public:
            ...
            RenderStateBuilder& setVSShader(ref_t<IShader> shader) { desc_.vsShader = shader; return * this;}
            RenderStateBuilder& setPSShader(ref_t<IShader> shader) { desc_.psShader = shader; return * this;}
            ...
            RenderStateBuilder& addInputElementDesriptor(ref_t<InputElementDesc> desc) { desc_.inputElements[desc_.inputElementCount] = desc; desc_.inputElementCount++;  return * this; }
